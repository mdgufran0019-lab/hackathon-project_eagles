...
const GlowCard: React.FC<GlowCardProps> = ({ children, className = '', glowColor = 'purple' }) => {
  ...
  return (
    <>
      ...
      <div
        ...
        className={`rounded-2xl relative grid shadow-[0_1rem_2rem_-1rem_black] p-4 gap-4 backdrop-blur-[5px] ${className}`}
      >
        <div data-glow></div>
        {children}
      </div>
